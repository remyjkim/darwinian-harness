...
function receiptObject(): ReleaseCandidateReceiptV1 {
  return {
    ...
    build: { version: "1.2.0", sourceCommit: COMMIT },
    tar: {
...
function validInput() {
  return {
    ...
    tag: { name: "v1.2.0", type: "tag" as const, peeledCommit: COMMIT },
...
describe("release candidate receipt parser", () => {
  ...
  test.each([
    ...
    ["bad SHA", () => JSON.stringify({ ...receiptObject(), build: { version: "1.2.0", sourceCommit: "A".repeat(40) } })],
