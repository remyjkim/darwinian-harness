...
import { OrgCommand } from "./commands/org/org";
import { OrgListCommand } from "./commands/org/list";
import { OrgUseCommand } from "./commands/org/use";
...
import { WorkerRetireCommand } from "./commands/worker/retire";
import { WorkerRegisterCommand } from "./commands/worker/register";
import { WorkerUseCommand } from "./commands/worker/use";
import { WorkerSecretSetCommand } from "./commands/worker/secret-set";
import { WorkerBuzzToolsCommand } from "./commands/worker/buzz-tools";
import { WorkerLaunchContextCommand } from "./commands/worker/launch-context/launch-context";
import { WorkerLaunchContextPrepareCommand } from "./commands/worker/launch-context/prepare";
import { WorkerLaunchContextListCommand } from "./commands/worker/launch-context/list";
import { WorkerLaunchContextPruneCommand } from "./commands/worker/launch-context/prune";
...
cli.register(WorkerLaunchContextCommand);
cli.register(WorkerLaunchContextPrepareCommand);
cli.register(WorkerLaunchContextListCommand);
cli.register(WorkerLaunchContextPruneCommand);
...
cli.register(WorkerRegisterCommand);
cli.register(WorkerUseCommand);
cli.register(WorkerSecretSetCommand);
cli.register(WorkerBuzzToolsCommand);
